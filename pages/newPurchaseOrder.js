...
const NewPurchaseOrder = () => {
  ...
  const form = (
    <div className="new_po_order_form">
      ...
      <div className="fields centered">
        {size.width > "600" ? (
          <label style={{ marginBottom: "0.5rem" }}>Order Description:</label>
        ) : null}
        {orderType ? (
          <div>
            {orderType == "BOM" ? (
      ...
      <div className="fields centered">
        {size.width > "600" ? (
          <label style={{ marginBottom: "0.5rem" }}>Required Quantity:</label>
        ) : null}
        {showUnit ? (
          <div
            style={{
